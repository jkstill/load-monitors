...
begin
	...
	:end_snap_id := statspack.snap(
		i_snap_level => 7,
		i_ucomment => 'high load - end time ' || to_char(sysdate,'yyyy-mm-dd hh24:mi:ss')
	);
	--*/
...
-- commented out so this can run from shell script in background
-- ed &save_report_name
